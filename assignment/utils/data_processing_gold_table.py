...
def compute_labels(apps_df, loan_df, dpd_threshold=30, mob_threshold=6):
    """
    ...
    Args:
        ...
        mob_threshold: MOB threshold to consider (default: 6)
...
def process_gold_feature_store(asof_date_str, silver_directory, gold_directory, spark):
    ...
    try:
        ...
        # Compute labels
        labels_df = compute_labels(apps_df, loan_df, dpd_threshold=30, mob_threshold=6)
